...
CMSIS-DSP.1.16.1/Examples/ARM/arm_dotproduct_example/RTE/Device/ARMCM4_FP/%.o: ../CMSIS-DSP.1.16.1/Examples/ARM/arm_dotproduct_example/RTE/Device/ARMCM4_FP/%.c $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Building file: "$<"'
