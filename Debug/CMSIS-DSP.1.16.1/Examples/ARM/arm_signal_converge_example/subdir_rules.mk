...
CMSIS-DSP.1.16.1/Examples/ARM/arm_signal_converge_example/%.o: ../CMSIS-DSP.1.16.1/Examples/ARM/arm_signal_converge_example/%.c $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Building file: "$<"'
